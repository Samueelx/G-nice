  ...
  return (
    <div className="p-4 bg-gray-50 min-h-screen">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {events.map((event) => (
          <div key={event.id} className="relative bg-white rounded-2xl overflow-hidden shadow-sm">
            <div className="relative">
              ...
              />
              <div className="absolute top-3 right-3 bg-white rounded-lg p-2 text-sm">
