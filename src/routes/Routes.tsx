...
import PostDetails from "@/pages/PostDetails"; // Add this import

const userProfile = {
    username: "knightwing",
    handle: "knightwing.19",
    avatar:
        "https://plus.unsplash.com/premium_photo-1682124752476-40db22034a58?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
const router = createBrowserRouter([
    ...
    },
    {
        ...
        element: (
            <PrivateRoute>
                <AppLayout>
                    <LandingPage setIsSidebarOpen={() => false} />
                </AppLayout>
            </PrivateRoute>
        ),
    },
